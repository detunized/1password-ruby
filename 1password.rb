...
class OnePassword
    ...
    def verify_key
        ...
        response = post ["auth", "verify"], encrypted_payload, mock_response
        JSON.load session_key.decrypt response
    end
    ...
    def get_account_info
        ...
        JSON.load session_key.decrypt get ["accountpanel"], mock_response
    end

    def sign_out
        put ["session", "signout"], {}, {ho: "ho-ho"}
    end
